...
public class ExcepcionManejador extends ResponseEntityExceptionHandler {
	...
	public ExcepcionManejador() {
		CODIGOS_ESTADO_HTTP.put(ExcepcionCampoObligatorio.class.getSimpleName(), HttpStatus.METHOD_NOT_ALLOWED.value());
		CODIGOS_ESTADO_HTTP.put(ExcepcionValorInvalido.class.getSimpleName(), HttpStatus.METHOD_NOT_ALLOWED.value());
		CODIGOS_ESTADO_HTTP.put(ExcepcionRegistroExistente.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
		CODIGOS_ESTADO_HTTP.put(ExcepcionRegistroNoExistente.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
	}
